...
public class DNMeterialTextField:UITextField
{
    ...
    open  func addborderLayerOnView() {
        ...
        self.layer.sublayers?.forEach { if $0.name == "border_main" || $0.name == "border_hidden"
        ...
        mainBorderOutline.name = "border_main"
        ...
        hiddenBorderOtline.name = "border_hidden"
    ...
    @objc func textFieldDidBeginEditing(_ textField: UITextField) {
        self.floatingLabel.textColor = .systemGreen // activeBorderColor
